...
public class UpdateWorkoutTemplateDayExerciseDtoValidator : AbstractValidator<UpdateWorkoutTemplateDayExerciseDto>
{
    public UpdateWorkoutTemplateDayExerciseDtoValidator()
    {
